...
class BaseComparator(Generic[T], ABC):
    ...
    >>> from astrotech.record import MinScalarComparator
    ...
    def equal(self, other: Any) -> bool:
        ...
        >>> from astrotech.record import MinScalarComparator, MaxScalarComparator
        >>> comparator = MinScalarComparator()
...
class MaxScalarComparator(BaseComparator[float]):
    ...
    >>> from astrotech.record import MaxScalarComparator
