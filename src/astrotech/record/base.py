...
class BaseRecord(Generic[T], ABC, metaclass=AbstractFactory):
    r"""Definition of a base class to track a record of values.
    ...
    >>> from astrotech.record import Record
    >>> record = Record("loss")
    ...
    def get_best_value(self) -> T:
        ...
        >>> from astrotech.record import MaxScalarRecord
    ...
    def config_dict(self) -> dict[str, Any]:
        ...
        >>> from astrotech.record import BaseRecord, Record
    ...
    def from_dict(cls, data: dict) -> BaseRecord:
        ...
        >>> from astrotech.record import BaseRecord
        >>> from objectory import OBJECT_TARGET
        >>> record = BaseRecord.from_dict(
        ...     {
        ...         "config": {
        ...             OBJECT_TARGET: "astrotech.record.Record",
        ...             "name": "loss",
        ...             "max_size": 7,
        ...         },
